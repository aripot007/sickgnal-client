...
mod tests {
    ...
    fn test_derive_key_deterministic() {
        ...
        let key1 = Config::derive_key_from_password(password, &salt).unwrap();
        let key2 = Config::derive_key_from_password(password, &salt).unwrap();
    ...
    fn test_different_passwords_different_keys() {
        ...
        let key1 = Config::derive_key_from_password("password1", &salt).unwrap();
        let key2 = Config::derive_key_from_password("password2", &salt).unwrap();
    ...
    fn test_different_salts_different_keys() {
        ...
        let key1 = Config::derive_key_from_password(password, &salt1).unwrap();
        let key2 = Config::derive_key_from_password(password, &salt2).unwrap();
    ...
    fn test_new_generates_salt() {
        ...
        let config = Config::new(db_path.clone(), "password", Some(salt_path.clone())).unwrap();
    ...
    fn test_new_reuses_salt() {
        ...
        let config1 = Config::new(db_path.clone(), "password", Some(salt_path.clone())).unwrap();

        // Create config second time with same password
        let config2 = Config::new(db_path.clone(), "password", Some(salt_path.clone())).unwrap();
